...
class AddEditForm extends React.Component {
    ...
    componentDidMount() {
        if(this.props.item) {
            const { id, first, last, email, phone, location, profession } = this.props.item
            this.setState({ id, first, last, email, phone, location, profession })
        }
    }
    render() {
        return (
            <Form onSubmit={this.props.item ? this.submitFormEdit : this.submitFormAdd}>
                ...
                <FormGroup>
                    <Label for="location">Työmaa</Label>
                ...
                <FormGroup>
                    ...
                    <Input type="text" name="profession" id="profession" onChange={this.onChange} value={this.state.profession === null ? '' : this.state.profession} />
                </FormGroup>
